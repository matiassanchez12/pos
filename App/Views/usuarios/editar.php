...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h4 class="h3 mb-5 text-gray-800"><i class="fas fa-user-edit"></i> <?php echo $titulo ?></h4>
    ...
    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>/usuarios/actualizar">
        ...
        <div class="row mt-4">
            <div class="form-group col-12 col-sm-8 mt-2">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <label>Usuario</label>
                        <input type="text" name="usuario" id="usuario" class="form-control" value="<?php echo $datos['usuario']; ?>" autofocus required>
                    </div>
                    <div class="col-12 col-sm-6">
                        <label>Nombre</label>
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <select name="id_rol" class="form-control" id="id_rol" required>
                            ...
                            <?php foreach ($roles as $rol) { ?>
                                <option value="<?php echo $rol['id']; ?>" <?php if ($rol["id"] == $datos["id_rol"]) {
                                                                                echo 'selected';
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <select name="id_caja" class="form-control" id="id_caja" required>
                            ...
                            <?php foreach ($cajas as $caja) { ?>
                                <option value="<?php echo $caja['id']; ?>" <?php if ($caja["id"] == $datos["id_caja"]) {
                                                                                echo 'selected';
            ...
            <div class="form-group col-12 col-sm-4 text-center">
                ...
                <label for="imagen_usuario" class="mt-4 mb-4 mx-auto d-block position-relative" style="width:180px; height:150px;">
                    <img src="<?php echo base_url() . "/images/avatars/users-upload/" .  $datos['id'] . ".png?" . time(); ?>" id="imagen" class="btn img-effect img-responsive rounded-circle img-thumbnail" alt="img" style="max-width: 100%; height:150px">
