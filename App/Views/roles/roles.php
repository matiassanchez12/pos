    ...
    <div class="container-fluid">
        ...
        <div>
            <p>
                <a href="<?php echo base_url(); ?>/roles/nuevo" class="btn btn-primary"><i class="fas fa-plus"></i> Agregar</a>
                <a href="<?php echo base_url(); ?>/roles/eliminados" class="btn btn-info">Eliminados <i class="fas fa-arrow-right"></i></a>
            </p>
        </div>
        <!-- DataTales Example -->
