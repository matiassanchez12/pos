...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h4 class="h3 mb-2 text-gray-800"><i class="fas fa-store"></i> Mi tienda </h4>
    ...
    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>/configuracion/actualizar">
        ...
        <div class="row  mt-4">
            <div class="card shadow p-4 form-group col-12 col-sm-7">
                <h5 class="m-0 text-gray-800">Datos generales</h5>
            ...
            <div class="card p-4 ml-5 form-group col-12 col-sm-4 text-center">
                <h5 class="m-0 text-gray-800" id="titulo_imagen"><i class="fas fa-camera"></i> Logotipo de la empresa</h5>
                <hr class="sidebar-divider d-none d-md-block">
